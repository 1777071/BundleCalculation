            ...
            for(int j=bundleSize.size()-1;j>=0;j--){
                ...
                if((i-orderBundle.get(j)==0)){
                    ...
                    if(auoqtoli.contains(i-orderBundle.get(j))){
                        ...
                        auoqtoli.add(i);
                        //System.out.println(mid+"========"+i+"=========="+(mid.get(orderBundle.get(j))+1)+"===="+(i-orderBundle.get(j)));
                        //System.out.println(orderBundle+"======"+orderBundle.get(i-orderBundle.get(j)));
                ...
                for (int bundle:orderBundle) {
                    if(i<bundle){
                     ...
                     break;
                        ...
                        //System.out.println(bundleCounts+"===="+currentBundle+"==="+bundle);
